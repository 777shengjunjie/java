...
Scroller.prototype = /** @lends Scroller.prototype */{
	 ...
	 *  @param {int} [virtual=false] Perform the calculations in the virtual ssmweb.domain
	...
	/**
	 * Convert from one ssmweb.domain to another. The physical ssmweb.domain is the actual
	 ...
	 * only to that maximum value and virtual / physical ssmweb.domain transforms will
